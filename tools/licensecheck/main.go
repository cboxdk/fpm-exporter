...
var exceptions = map[string]exception{
	"github.com/shoenig/go-m1cpu": {
		license: "MPL-2.0",
		reason: "File-level copyleft, pulled in transitively by gopsutil for Apple " +
			"Silicon CPU detection. We redistribute it unmodified, which MPL-2.0 " +
			"permits inside a larger work without affecting our own licensing. If we " +
			"ever patch its files, those files must be published.",
	},
}
