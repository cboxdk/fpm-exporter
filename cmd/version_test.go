...
func TestVersionCommand_RunFunction(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			version:        "1.2.3",
			expectedOutput: "Cbox FPM Exporter version 1.2.3\n",
		},
		{
			name:           "with empty version",
			version:        "",
			expectedOutput: "Cbox FPM Exporter version \n",
		},
		{
			name:           "with development version",
			version:        "dev",
			expectedOutput: "Cbox FPM Exporter version dev\n",
		},
	}
